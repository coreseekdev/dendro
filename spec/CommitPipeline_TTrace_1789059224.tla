---- MODULE CommitPipeline_TTrace_1789059224 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789059224.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789059224.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {1},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1},nextSeq |-> 2,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2},nextSeq |-> 3,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2},nextSeq |-> 3,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2},installed |-> {2},installedMax |-> 2,lost |-> {},inFlight |-> {1, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {2}]),
    ([durable |-> {1, 2, 3},installed |-> {2},installedMax |-> 2,lost |-> {},inFlight |-> {1, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {2}]),
    ([durable |-> {1, 2, 3},installed |-> {2},installedMax |-> 2,lost |-> {},inFlight |-> {1, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {2}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {2},installedMax |-> 2,lost |-> {},inFlight |-> {1, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {2}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1, 2},installedMax |-> 2,lost |-> {},inFlight |-> {3, 4},nextSeq |-> 5,waterMark |-> 2,acked |-> {1, 2}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1, 2, 4},installedMax |-> 4,lost |-> {},inFlight |-> {3},nextSeq |-> 5,waterMark |-> 2,acked |-> {1, 2, 4}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1, 2, 4},installedMax |-> 4,lost |-> {3},inFlight |-> {},nextSeq |-> 5,waterMark |-> 2,acked |-> {1, 2, 4}])
    >>
----
...
---- CONFIG CommitPipeline_TTrace_1789059224 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:53:45 CST 2026