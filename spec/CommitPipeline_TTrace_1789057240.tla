---- MODULE CommitPipeline_TTrace_1789057240 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789057240.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789057240.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {2},inFlight |-> {1},nextSeq |-> 3,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {2},inFlight |-> {1, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {3},installed |-> {},installedMax |-> 0,lost |-> {2},inFlight |-> {1, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {3},installed |-> {},installedMax |-> 0,lost |-> {2},inFlight |-> {1, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {3},installed |-> {},installedMax |-> 0,lost |-> {1, 2},inFlight |-> {3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
...
---- CONFIG CommitPipeline_TTrace_1789057240 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:20:41 CST 2026