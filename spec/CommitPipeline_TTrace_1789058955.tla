---- MODULE CommitPipeline_TTrace_1789058955 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789058955.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789058955.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {3},installed |-> {},installedMax |-> 0,lost |-> {1, 2},inFlight |-> {3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
...
---- CONFIG CommitPipeline_TTrace_1789058955 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:49:16 CST 2026