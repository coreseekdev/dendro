---- MODULE CommitPipeline_TTrace_1789059101 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789059101.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789059101.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2},nextSeq |-> 3,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2, 3},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2, 3},installed |-> {},installedMax |-> 0,lost |-> {},inFlight |-> {1, 2, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {1, 2, 3},installed |-> {1},installedMax |-> 1,lost |-> {},inFlight |-> {2, 3, 4},nextSeq |-> 5,waterMark |-> 1,acked |-> {1}]),
    ([durable |-> {1, 2, 3},installed |-> {1},installedMax |-> 1,lost |-> {2},inFlight |-> {3, 4},nextSeq |-> 5,waterMark |-> 1,acked |-> {1}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1},installedMax |-> 1,lost |-> {2},inFlight |-> {3, 4},nextSeq |-> 5,waterMark |-> 1,acked |-> {1}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1, 4},installedMax |-> 4,lost |-> {2},inFlight |-> {3},nextSeq |-> 5,waterMark |-> 2,acked |-> {1, 4}]),
    ([durable |-> {1, 2, 3, 4},installed |-> {1, 4},installedMax |-> 4,lost |-> {2, 3},inFlight |-> {},nextSeq |-> 5,waterMark |-> 2,acked |-> {1, 4}])
    >>
----
...
---- CONFIG CommitPipeline_TTrace_1789059101 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:51:41 CST 2026