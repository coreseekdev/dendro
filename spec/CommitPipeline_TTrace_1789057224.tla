---- MODULE CommitPipeline_TTrace_1789057224 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789057224.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789057224.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {2},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2},nextSeq |-> 3,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {2},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {2, 3},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {2, 3},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {2, 3, 4},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2, 3, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {2, 3, 4},installed |-> {3},installedMax |-> 3,lost |-> {1},inFlight |-> {2, 4},nextSeq |-> 5,waterMark |-> 1,acked |-> {3}]),
    ([durable |-> {2, 3, 4},installed |-> {3, 4},installedMax |-> 4,lost |-> {1},inFlight |-> {2},nextSeq |-> 5,waterMark |-> 1,acked |-> {3, 4}]),
    ([durable |-> {2, 3, 4},installed |-> {3, 4},installedMax |-> 4,lost |-> {1, 2},inFlight |-> {},nextSeq |-> 5,waterMark |-> 1,acked |-> {3, 4}])
    >>
----
...
---- CONFIG CommitPipeline_TTrace_1789057224 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:20:24 CST 2026