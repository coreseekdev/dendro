---- MODULE CommitPipeline_TTrace_1789059043 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CommitPipeline_TTrace_1789059043.json", _TETrace)
...
\*
\*trace == IODeserialize("CommitPipeline_TTrace_1789059043.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {1},inFlight |-> {2, 3},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {1, 3},inFlight |-> {2},nextSeq |-> 4,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {},installed |-> {},installedMax |-> 0,lost |-> {1, 3},inFlight |-> {2, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {4},installed |-> {},installedMax |-> 0,lost |-> {1, 3},inFlight |-> {2, 4},nextSeq |-> 5,waterMark |-> 0,acked |-> {}]),
    ([durable |-> {4},installed |-> {4},installedMax |-> 4,lost |-> {1, 3},inFlight |-> {2},nextSeq |-> 5,waterMark |-> 1,acked |-> {4}]),
    ([durable |-> {2, 4},installed |-> {4},installedMax |-> 4,lost |-> {1, 3},inFlight |-> {2},nextSeq |-> 5,waterMark |-> 1,acked |-> {4}]),
    ([durable |-> {2, 4},installed |-> {4},installedMax |-> 4,lost |-> {1, 2, 3},inFlight |-> {},nextSeq |-> 5,waterMark |-> 1,acked |-> {4}])
    >>
----
...
---- CONFIG CommitPipeline_TTrace_1789059043 ----
CONSTANTS
    MaxSeq = 4
    NIL = 0
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 11 00:50:44 CST 2026