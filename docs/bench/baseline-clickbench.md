...
### 10M 部分基线（2026-09-19，P0 窄行后；q24 硬杀前全程 RSS ≤5.7GB）

装载 10M 行 RSS 稳定 2.57GB；查询阶段（median of 3，ms）：

| 查询 | 10M | 1M 基线 | 倍率 |
|------|-----|---------|------|
| q01 COUNT(*)（捷径） | **18** | 1132 | 捷径在 10M 反而远快于 1M 行式 |
| q03 SUM+COUNT+AVG（捷径） | **292** | 1332 | 同上 |
| q04 AVG（捷径） | **137** | 1176 | 同上 |
| q07 MIN/MAX（捷径） | **510** | 1480 | 同上 |
| q02 COUNT WHERE | 2253 | 867 | 2.6×（10× 数据） |
| q05/q06 COUNT DISTINCT | 4761/4636 | 1371/1344 | 3.5× |
| q08-q18 GROUP BY 族 | 2235-12705 | 947-1713 | 4-7×（P0 亚线性） |
| q20/q22/q23 LIKE 族 | 2361/5645/9303 | 906/1861/2156 | 2.6-4.3× |

- q21 一次运行报 `column "URL" does not exist`——6 种隔离复现
 （单跑/前缀序列/ANALYZE 前缀/4× 重复）均无法复现；已加诊断
